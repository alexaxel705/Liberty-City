local LibertyTexture = dxCreateTexture('radarlc.png')
local radar = {}
local Offset = {[1] = -222, [2] = 8}
local Size = 124
...
addEvent("LibertyRadar", true)
addEventHandler("LibertyRadar", localPlayer, LibertyRadar)
...
function CreateBlip(x, y, z, icon, size, r, g, b, a, ordering, visibleDistance, info)
	...
	setElementDimension(bl, 1)
end




CreateBlip(840, 638, 0, 63, 0, 0, 0, 0, 0, 0, 300, "Pay 'n' Spray")
CreateBlip(290, 506, 0, 63, 0, 0, 0, 0, 0, 0, 300, "Pay 'n' Spray")
CreateBlip(-1223, 1053, 0, 63, 0, 0, 0, 0, 0, 0, 300, "Pay 'n' Spray")
CreateBlip(985, 601, 0, 18, 0, 0, 0, 0, 0, 0, 300, "Ammo")
CreateBlip(264, 281, 0, 18, 0, 0, 0, 0, 0, 0, 300, "Ammo")
